...
let ``Example1`` () =
    ...
    Assert.Equal(Some 1125899906842624L ,actual.Output)
...
let ``Example2`` () =
    ...
    let actual = run input None 
    Assert.Equal(Some 1219070632396864L ,actual.Output)
...
let ``Example3`` () =
    ...
    let actual = run input None 
    Assert.Equal(Some 99L ,actual.Output)
